---
title: "Transformer 架构学习总结"
description: "从注意力机制到 Transformer 各模块的系统学习记录。"
publishDate: "2025-10-28"
updatedDate: "2025-10-28"
category: "tech"
tags: ["Transformer","深度学习","注意力机制"]
draft: false
featured: true
---
...
### 它是怎么工作的：
每个单词在词汇表中都有一个唯一的索引（例如，“apple”是 10，“banana”是 20）。Embedding Matrix 是一个大小为 [词汇表大小, 模型维度] 的矩阵。例如，如果词汇表有 50000 个词，我们想要的向量维度是 512，那么这个矩阵就是 [50000, 512]。当输入单词索引 “10” 时，Embedding 层就从这个矩阵中取出第 10 行。这个长度为 512 的向量就是单词 “apple” 的嵌入表示。类比于一本词典，我们知道单词索引后就能知道该词在词典中的位置，而这个512维的向量则存储了该单词的具体含义。
...
<img width="672" height="399" alt="Image" src="https://github.com/user-attachments/assets/5c1e11c5-b32e-4341-bb46-ccd03fd17a20" />
